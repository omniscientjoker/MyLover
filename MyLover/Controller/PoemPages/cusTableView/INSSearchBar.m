...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), 34.0)]))
	{
		...
		self.searchImageViewOn.image = [UIImage imageNamed:@"button_type_searchEnd"];
		...
		self.searchImageCircle.image = [UIImage imageNamed:@"SearchCircle"];
		...
		self.searchImageCrossLeft.image = [UIImage imageNamed:@"SearchBar_1"];
		...
		self.searchImageCrossRight.image = [UIImage imageNamed:@"SearchBar_2"];
		...
		self.searchImageViewOff.image = [UIImage imageNamed:@"button_type_searchBegin"];
