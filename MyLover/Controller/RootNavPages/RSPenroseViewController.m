...
- (void)viewDidLoad
{
    ...
    self.penroseView = [[RSPenroseView alloc] initWithFrame:CGRectMake((SCREENWIDTH-320)/2, 0, 320, 260)];
    //
    self.penroseViewContainer = [[UIView alloc] initWithFrame:CGRectMake(0, originYOut, SCREENWIDTH, 260)];
